    ...
    <>
      ...
      >
        <Select placeholder="Seleziona la forma">
          ...
          <Select.Option value="duePiani">Su due piani</Select.Option>
          <Select.Option value="trePiani">Su tre piani</Select.Option>
      ...
      >
        <Select placeholder="Seleziona la base">
          ...
          <Select.Option value="cake-al-cioccolato">
            Cake al cioccolato
          </Select.Option>
          <Select.Option value="cake-al-limone">Cake al limone</Select.Option>
          <Select.Option value="cake-alle-nocciole">
            Cake alle nocciole
          </Select.Option>
          <Select.Option value="cake-alle-carote">
            Cake alle carote
          </Select.Option>
          <Select.Option value="frolla-croccante">
            Frolla croccante
          </Select.Option>
        </Select>
      </Form.Item>
      ...
      >
        <Select placeholder="Seleziona la bagna">
          <Select.Option value="semplice-vaniglia">
            Semplice alla vaniglia
          </Select.Option>
      ...
      >
        <Select placeholder="Seleziona la crema">
          ...
          <Select.Option value="vaniglia-cioccolato">Vaniglia con gocce di cioccolato</Select.Option>
        </Select>
      </Form.Item>
      ...
      >
        <Select placeholder="Seleziona il topping">
          ...
          <Select.Option value="pasta-di-zucchero">Copertura in pasta di zucchero</Select.Option>
        </Select>
      </Form.Item>
